...
const Home = () => {
  return (
    <main className="flex h-full flex-col items-center justify-between pb-24 pt-14">
      <div className="z-10 w-11/12 items-center justify-between text-center font-mono text-sm">
      ...
      <div className='flex flex-row w-full'>
        <div className='h-screen w-3/4 p-16 space-y-10'>
          <Image src="/assets/ad_1.png" width={500} height={500} alt="None" className='rounded-xl' />
          <Image src="/assets/ad_2.png" width={500} height={500} alt="None" className='rounded-xl' />
          <Image src="/assets/ad_3.png" width={500} height={500} alt="None" className='rounded-xl' />
          <Image src="/assets/ad_7.png" width={500} height={500} alt="None" className='rounded-xl' />
        </div>

        <text className="my-10 font-light leading-8 tracking-wider">
          ...
          <br></br>
          <br></br>
          "I'll come back tomorrow," Maya promised, a genuine smile lighting up her face. The fox blinked, then disappeared as quickly as it had come, leaving only a rustle in the bushes in its wake. The park felt less lonely suddenly, as if a new kind of friendship had bloomed amidst the swings and slides.
        </text>

        <div className='h-screen w-3/4 p-16 space-y-10'>
          <Image src="/assets/ad_4.png" width={500} height={500} alt="None" className='rounded-xl' />
          <Image src="/assets/ad_5.png" width={500} height={500} alt="None" className='rounded-xl' />
          <Image src="/assets/ad_6.png" width={500} height={500} alt="None" className='rounded-xl' />
        </div>
      </div>
      ...
      <div className="rounded-lg border border-transparent border-white border-opacity-20 px-20 py-5 text-center transition-all hover:border-2 hover:border-opacity-25 active:border">
        <Link href="http://localhost:3000/ads/survey" className="group" target="_blank" rel="noopener noreferrer" >
          <h2 className={`text-2x1 mb-1 font-semibold`}>Complete</h2>
          <p className={`text-sm opacity-50`}>Finish reading and complete a short survey</p>
        </Link>
      </div>
    </main>
  );
